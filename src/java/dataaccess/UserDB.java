...
public class UserDB {
    ...
    public int insert(User user) throws HomeInventoryDBException {
    ...
    public int update(User user) throws HomeInventoryDBException {
        EntityManager em = DBUtil.getEmFactory().createEntityManager();
        EntityTransaction trans = em.getTransaction();
        try {
            trans.begin();
            ...
            throw new HomeInventoryDBException("Error updating user");
        } finally {
            em.close();
        }
    }
